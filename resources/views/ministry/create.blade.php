            ...
            <div class="row mb-2">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"> <a href="{{route('ministries.index')}}">Churches</a></li>
    ...
    <section class="content">
        <div class="container-fluid">                         
            ...
            <div class="card card-warning">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form role="form" enctype="multipart/form-data" method="post" action="{{route('ministries.store')}}">{{ csrf_field() }}
                        <div class="row">
                            <div class="col-md-6">
                                <!-- text input -->
